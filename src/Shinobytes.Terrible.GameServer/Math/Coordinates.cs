...
namespace Shinobytes.Terrible.Math
{
    public static class Coordinates
    {
        ...
        public static GeoCoordinate Offset(double latitude, double longitude, double meters)
        {
            ...
            // pi / 180 = 0.018
            var newLong = longitude + coef / System.Math.Cos(latitude * 0.018);
        ...
        public static GeoCoordinate Offset(GeoCoordinate coordinate, double metersNorth, double metersEast)
        {
            ...
            double dLat = dn / r;
            double dLon = de / (r * System.Math.Cos(System.Math.PI * lat / 180));
            //OffsetPosition, decimal degrees 
            double latO = lat + dLat * 180 / System.Math.PI;
            double lonO = lon + dLon * 180 / System.Math.PI;
        ...
        public static GeoCoordinate CalculateDerivedPosition(this GeoCoordinate source, double range, double bearing)
        {
            ...
            var lat = System.Math.Asin(
                System.Math.Sin(latA) * System.Math.Cos(angularDistance) +
                System.Math.Cos(latA) * System.Math.Sin(angularDistance) * System.Math.Cos(trueCourse));

            var dlon = System.Math.Atan2(
                System.Math.Sin(trueCourse) * System.Math.Sin(angularDistance) * System.Math.Cos(latA),
                System.Math.Cos(angularDistance) - System.Math.Sin(latA) * System.Math.Sin(lat));

            var lon = ((lonA + dlon + System.Math.PI) % (System.Math.PI * 2)) - System.Math.PI;
        ...
        public static GeoBounds GetBoundingBox(GeoCoordinate point, double halfSideInKm)
        {
            ...
            var pradius = radius * System.Math.Cos(lat);
        ...
        private static double Rad2Deg(double rad) => rad / System.Math.PI * 180.0;
